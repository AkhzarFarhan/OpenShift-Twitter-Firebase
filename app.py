#!/usr/bin/python3
# [[[[[[Edit the class Arguments to get desired result]]]]]]
...
async def outTweet(tweet):
    ...
    if arg.o != None:
        if arg.csv:
            ...
            url = 'gs://twitterbotfortelegram.appspot.com/text.json'
...
class Arguments:
    ...
    t = None
    timedelta = None
    year = None # Filter tweets before this year
    since = None # Finds tweet since this tear
    until = None # Finds tweet until this year
    fruit = None
    tweets = False
    verified = False
    users = False
